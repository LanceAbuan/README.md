...
export const aboutData: AboutData = {
  paragraphs: [
    ...
    {
      text: "I graduated Magna Cum Laude from Texas A&M University with a Bachelor of Science in Computer Science and a minor in Mathematics.",
      highlights: ["Magna Cum Laude", "Texas A&M University", "Computer Science", "Mathematics"],
    },
    {
  ...
  stats: [
    ...
    { icon: "graduation-cap", label: "Education", value: "B.S. CS, Min. Math" },
    { icon: "map-pin", label: "Location", value: "Carrollton, TX" },
    { icon: "mail", label: "Email", value: "lance@lanceabuan.tech" },
  ],
};
